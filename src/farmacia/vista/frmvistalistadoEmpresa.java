 ...
 * @author fecyp
 */
public class frmvistalistadoEmpresa extends EstrategiaFrameVistas implements ActionListener, KeyListener, MouseListener {

    frmvistalistadoEmpresa(String titulo) {
       super(titulo);

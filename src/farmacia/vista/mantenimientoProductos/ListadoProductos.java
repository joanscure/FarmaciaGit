...
public class ListadoProductos extends JPanel implements ActionListener, KeyListener {
    ...
    public JScrollPane clientes_tabla() {
        ...
        Object[] a2 = {1, "00038", "paracetamol", "cura enfermedades", "200mg", 7.8, 1.8, 8.9, 100, 1};
        Object[] a3 = {2, "00023", "ibuprofeno", "alivia dolor", "500mg", 7.8, 1.8, 8.9, 140, 1};
        Object[] a1 = {3, "00012", "aspirina", "cura dolor de cabez", "100mg", 7.8, 1.8, 8.9, 80, 1};
        modelo.addRow(a2);
        modelo.addRow(a1);
        modelo.addRow(a3);
